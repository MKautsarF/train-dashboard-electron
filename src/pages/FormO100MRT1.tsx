...
const FormO100MRT = () => {
  ...
  const filepath = "C:/Train Simulator/Data/Tabel_0_100mrt1.json";
...
;
  ...
  const setOCCData = () => {
    let i = 0;
    for (let j = occData.ROUTE.length - 2; j >= 0; j--) {
      for (let k = 1; k < occData.ROUTE[j].line1.length; k++) {
        occData.ROUTE[j].line1[k].speedLimit = Number(rows[i].max_speed);
      }
      i++;
    }
  }
    ...
    try {
      ...
      autoTable(doc, {
        body: [
          [
            {
              content: "Tabel Penomoran Kereta Api Asik",
              colSpan: 4,
              rowSpan: 1,
              styles: {
                halign: "center",
      ...
      autoTable(doc, {
        ...
        body: [
          ...
          [
            ...
            {
              content: formatTime(BundHIStation.departure),
              rowSpan: 2,
              //colSpan: 1,
              styles: {
                halign: "center",
          ...
          [
            {
              content: subtractFormattedTimes(dukuhatasStation.arrival,BundHIStation.departure),
              rowSpan: 2,
              //colSpan: 1,
              styles: {
                halign: "center",
            ...
            {
              content: BundHIStation.op_speed,
              rowSpan: 2,
              //colSpan: 1,
              styles: {
                halign: "center",
            ...
            {
              content: BundHIStation.max_speed,
              rowSpan: 2,
              //colSpan: 1,
              styles: {
                halign: "center",
          ...
          [
            {
              content: subtractFormattedTimes(setiabudiStation.arrival,dukuhatasStation.departure),
              rowSpan: 2,
              //colSpan: 1,
              styles: {
                halign: "center",
          ...
          [
            {
              content: subtractFormattedTimes(benhilStation.arrival,setiabudiStation.departure),
              rowSpan: 2,
              //colSpan: 1,
              styles: {
                halign: "center",
          ...
          [
            {
              content: subtractFormattedTimes(istoraStation.arrival,benhilStation.departure),
              rowSpan: 2,
              //colSpan: 1,
              styles: {
                halign: "center",
          ...
          [
            {
              content: subtractFormattedTimes(senayanStation.arrival,istoraStation.departure),
              rowSpan: 2,
              //colSpan: 1,
              styles: {
                halign: "center",
          ...
          [
            {
              content: subtractFormattedTimes(aseanStation.arrival,senayanStation.departure),
              rowSpan: 2,
              //colSpan: 1,
              styles: {
                halign: "center",
          ...
          [
            {
              content: subtractFormattedTimes(blokmStation.arrival,aseanStation.departure),
              rowSpan: 2,
              //colSpan: 1,
              styles: {
                halign: "center",
          ...
          [
            {
              content: subtractFormattedTimes(blokaStation.arrival,blokmStation.departure),
              rowSpan: 2,
              //colSpan: 1,
              styles: {
                halign: "center",
          ...
          [
            {
              content: subtractFormattedTimes(hajinawiStation.arrival,blokaStation.departure),
              rowSpan: 2,
              //colSpan: 1,
              styles: {
                halign: "center",
          ...
          [
            {
              content: subtractFormattedTimes(cipeterayaStation.arrival,hajinawiStation.departure),
              rowSpan: 2,
              //colSpan: 1,
              styles: {
                halign: "center",
          ...
          [
            ...
            {
              content: formatTime(lebakbulusStation.arrival),
              rowSpan: 2,
              //colSpan: 1,
              styles: {
                halign: "center",
          ...
          [
            {
              content: subtractFormattedTimes(fatmawatiStation.arrival,cipeterayaStation.departure),
              rowSpan: 2,
              //colSpan: 1,
              styles: {
                halign: "center",
          ...
          [
            {
              content: subtractFormattedTimes(lebakbulusStation.arrival,fatmawatiStation.departure),
              rowSpan: 2,
              //colSpan: 1,
              styles: {
                halign: "center",
        ...
        autoTable(doc, {
          ...
          body: [
            ...
            [
              ...
              {
                content: nextTime(lebakbulusStation.arrival, 7),
                colSpan: 1,
                styles: {
                  halign: "center",
                  valign: "middle",
