...
const ScoringMRT = () => {
  ...
  const mrtjson = fs.readFileSync(jsonPath, 'utf-8');

  const [jsonToWrite, setJsonToWrite] = useState(JSON.parse(mrtjson));
